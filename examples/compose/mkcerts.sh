...

{
	...
	SERVER_CRT_CN='Container daemon server'
	SERVER_CRT_SAN="DNS:$(hostname -f),DNS:cetusguard,DNS:dockerd,DNS:localhost,IP:127.0.0.1,IP:::1"
	...
	CLIENT_CRT_CN='Container daemon client'
