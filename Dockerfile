...
FROM --platform=${BUILDPLATFORM:-linux/amd64} docker.io/golang:1.23.4-bookworm@sha256:2e838582004fab0931693a3a84743ceccfbfeeafa8187e87291a1afea457ff7a AS build
