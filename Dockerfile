...
FROM --platform=${BUILDPLATFORM:-linux/amd64} docker.io/golang:1.20.3-bullseye@sha256:595c9af0430dd84bad33020e7e9e328af4bd1a1aabd46a03b5bf6f252cdbecf3 AS build
